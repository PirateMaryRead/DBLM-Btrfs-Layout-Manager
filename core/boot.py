...
def regenerate_grub(config_path: str | None = None) -> bool:
    """
...
def install_systemd_boot(efi_path: str | None = None) -> bool:
    """
...
def update_systemd_boot(efi_path: str | None = None) -> bool:
...
def ensure_loader_entries_dir(efi_mountpoint: str) -> Path:
...
def write_systemd_boot_entry(
    *,
    ...
    """
    entries_dir = ensure_loader_entries_dir(efi_mountpoint)
...
def delete_systemd_boot_entry(*, efi_mountpoint: str, entry_name: str, missing_ok: bool = True) -> Path:
